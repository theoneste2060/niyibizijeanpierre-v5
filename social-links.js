// Load social links from JSON and inject into footer
async function loadSocialLinks() {
  try {
    ...
    if (footer && !footer.querySelector('.social-icons')) {
      ...
      // Insert social icons before the first paragraph in footer
      const firstP = footer.querySelector('p');
      if (firstP) {
        firstP.insertAdjacentHTML('beforebegin', socialIconsHtml);
      }
    }
  } catch (error) {
...
// Load social links when page loads
